...
class Ui_Reservar(object):
    def setupUi(self, Reservar):
        ...
        Reservar.resize(598, 439)
        Reservar.setMinimumSize(QSize(598, 439))
        ...
        self.vcTxtTelefono.setEnabled(False)
        font2 = QFont()
        ...
        self.vccboBoxTipoRes.setFont(font2)
        ...
        self.vccboBoxTipoCocina.setFont(font2)
        ...
        sizePolicy3.setHeightForWidth(self.vcSpinBoxJornadas.sizePolicy().hasHeightForWidth())
        self.vcSpinBoxJornadas.setSizePolicy(sizePolicy3)
        self.vcSpinBoxJornadas.setFont(font2)
        ...
        self.vcSpinBoxNAsist.setFont(font2)
        self.vcSpinBoxNAsist.setMaximum(999)

        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.vcSpinBoxNAsist)

        self.vccboBoxClientes = QComboBox(Reservar)
        self.vccboBoxClientes.setObjectName(u"vccboBoxClientes")
        self.vccboBoxClientes.setFont(font2)

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.vccboBoxClientes)
        ...
        self.vcbtnEliminar = QPushButton(Reservar)
        ...
        self.vcbtnReservar.setFont(font1)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.vccboBoxClientes.setToolTip(QCoreApplication.translate("Reservar", u"Tipo de reserva", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.vcbtnEliminar.setToolTip(QCoreApplication.translate("Reservar", u"Confirmar reserva", None))
#endif // QT_CONFIG(tooltip)
        self.vcbtnEliminar.setText(QCoreApplication.translate("Reservar", u"Eliminar", None))
#if QT_CONFIG(tooltip)
